...
export default function SwipeInterfaceDesktop({ products, onAddToCart, onAddToBucket, user, showToast, onReachEnd, loading, hasMore }) {
    ...
    if (!currentProduct) {
        ...
        return (
            <div className="text-center py-16 h-full flex flex-col justify-center items-center">
                ...
                <p className="text-gray-500 max-w-xs">There are no more products matching your current filters. Check back later or adjust your filters.</p>
            </div>
        )
    }
